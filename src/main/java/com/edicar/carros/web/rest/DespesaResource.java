...
/**
 * REST controller for managing {@link com.edicar.carros.domain.Despesa}.
 */
@RestController
@RequestMapping("/api")
public class DespesaResource {
     ...
     */
    @GetMapping("/despesas")
    public ResponseEntity<List<Despesa>> getAllDespesas(Pageable pageable) {
        log.debug("REST request to get a page of Despesas");
        Page<Despesa> page = despesaService.findAll(pageable);
