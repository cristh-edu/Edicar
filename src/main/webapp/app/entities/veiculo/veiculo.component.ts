...
export class VeiculoComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.veiculoService
      ...
      .subscribe(
        (res: HttpResponse<IVeiculo[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInVeiculos(): void {
    this.eventSubscriber = this.eventManager.subscribe('veiculoListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IVeiculo[] | null, headers: HttpHeaders, page: number): void {
