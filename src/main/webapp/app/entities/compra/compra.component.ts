...
export class CompraComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.compraService
      ...
      .subscribe(
        (res: HttpResponse<ICompra[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInCompras(): void {
    this.eventSubscriber = this.eventManager.subscribe('compraListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ICompra[] | null, headers: HttpHeaders, page: number): void {
