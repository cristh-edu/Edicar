...
export class ModeloComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.modeloService
      ...
      .subscribe(
        (res: HttpResponse<IModelo[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInModelos(): void {
    this.eventSubscriber = this.eventManager.subscribe('modeloListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IModelo[] | null, headers: HttpHeaders, page: number): void {
