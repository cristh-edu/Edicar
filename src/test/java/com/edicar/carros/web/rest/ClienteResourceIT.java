...
import com.edicar.carros.domain.Cliente;
import com.edicar.carros.repository.ClienteRepository;
import com.edicar.carros.service.ClienteService;
...
public class ClienteResourceIT {
    ...
    private static final String DEFAULT_NM_CLIENTE = "AAAAAAAAAA";
    private static final String UPDATED_NM_CLIENTE = "BBBBBBBBBB";
    ...
    @Test
    @Transactional
    public void checkNmClienteIsRequired() throws Exception {
